  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Location',
      details: 'Ghaziabad, Uttar Pradesh',
      color: 'from-red-500 to-pink-500'
    },
    {
      icon: Mail,
      title: 'Email',
      details: 'panwarishant5626@gmail.com',
      color: 'from-blue-500 to-cyan-500'
    },
    {
      icon: Phone,
      title: 'Phone',
      details: '+91 9311689659',
      color: 'from-green-500 to-emerald-500'
    }
  ];

  const socialLinks = [
    { icon: Github, href: 'https://github.com/dashboard', color: 'hover:bg-gray-800' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/ishant-panwar-858312320/', color: 'hover:bg-blue-600' },
          ...
          >
            ...
            <div className="space-y-6 mb-8">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className={`w-12 h-12 bg-gradient-to-r ${info.color} rounded-full flex items-center justify-center text-white`}>
                    <info.icon size={20} />
                  </div>
                  <div>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className={`w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center text-gray-600 transition-all duration-300 ${social.color} hover:text-white`}
                  >
                    <social.icon size={20} />
                  </motion.a>
                ))}
